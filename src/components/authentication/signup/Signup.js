...
class Signup extends Component {
	...
	render() {
		return (
			<div
				id="signup"
				className="min-vh-100 bg-white d-flex flex-xl-row flex-column mx-auto align-items-center noselect justify-content-center"
			>
					...
					<form autoComplete="off" onSubmit={this.handleSubmit}>
						...
						<div className="form-group">
							<label htmlFor="year_of_study">
								<i className="fa fa-fw fa-hashtag" /> Year of
								study
							</label>
							<input
								type="number"
						...
						<small className="form-text text-muted mb-3">
							...
							<br /> Inclusion of at least one special character,
							e.g., ! @ # ? &#93;
						</small>
						<div className="form-group">
							<label htmlFor="confirmPassword">
								<i className="fa fa-fw fa-rocket" /> Re-enter
								password
							</label>
							<input
								type="password"
