    ...
    return (
      ...
      >
        ...
        >
          ...
          <div className="col-md-7 mx-5  my-auto p-3">
            <p
              className="lead"
        ...
        >
          <div className="d-flex flex-md-row flex-column ">
            <div className="col">
              <p className="subtitle text-muted">Faculty IDD</p>
              <p className="info">12345</p>
            </div>
          </div>
          <hr />
          <div className="d-flex flex-md-row flex-column mt-3 text-break">
            <div className="col">
              ...
              <p className="info ">faculty@somaiya.edu</p>
            </div>
          </div>
          <hr />
          ...
          {/* <div className="d-flex flex-md-row flex-column mt-3">
						<div className="col">
							<button
								className="btn btn-primary text-light border-primary py-2 px-4"
								onClick={() =>
