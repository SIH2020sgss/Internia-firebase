...
class InternshipDetails extends React.Component {
  toggleRequests = () => {
    $(".request-list").toggleClass("d-none");
  };
  render() {
    return (
      <div id="internship-details" className="container-fluid">
        <div className="container">
          <div className="brief-info bg-white rounded shadow-sm my-2 mx-auto p-3">
            ...
            <div className="row  text-muted my-2 p-1 d-md-flex other-details">
              <div className=" col-12 col-md-8">
                {/* <Link to="/feedback/:id"> */}
                <button
                  className="btn btn-outline-success btn-sm shdadow-sm"
                  onClick={() => {
          ...
          <div className="request-section d-flex flex-column shadow-sm px-3 p-3 mt-2 justify-content-center">
            <div className="request-header" onClick={this.toggleRequests}>
              <span className="title text-uppercase text-left font-weight-bold ">
                Requests{" "}
                <i
            ...
            <div className="request-list d-none  py-3">
              ...
              <div className="request bg-light mt-2 rounded p-2 py-3 d-flex flex-row align-items-center">
                ...
                >
                  ...
                  />
                  <span className="px-3" style={{ fontSize: "1.2em" }}>
                    Atharva Kitkaru
                  </span>
                </div>
