...
class Profile extends React.Component {
  ...
  render() {
    return (
      <div
        className="container-fluid bg-transparent prof-con mx-auto p-4 min-vh-100"
        id="profile"
      >
        <div
          className="container bg-white shadow mx-auto p-3 row"
        ...
        >
          ...
          <div className="d-flex flex-md-row flex-column pt-1">
